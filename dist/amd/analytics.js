define(['exports', 'aurelia-dependency-injection', 'aurelia-event-aggregator', 'aurelia-logging'], function (exports, _aureliaDependencyInjection, _aureliaEventAggregator, _aureliaLogging) {
	...
	var Analytics = (function () {
		function Analytics(eventAggregator) {
			...
			this._logger = _aureliaLogging.getLogger('analytics-plugin');
		...
		Analytics.prototype.init = function init(id, options, cmds) {
			options = options || {};
			...
			for (var _iterator = cmds, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
				var _ref;
